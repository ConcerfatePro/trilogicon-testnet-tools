...
| **MVP 3d-1** | `CliPayoutAdapter` skeleton behind disabled gate; no subprocess | No | No |
| **MVP 3d-2** | CLI argv construction + unit tests; verify command shape vs core | No | No |
